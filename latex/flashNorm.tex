...
In many implementations, a small epsilon $\epsilon$ is added to the RMS value to limit the resulting scaling factor $1/\rms$ and to avoid division by 0 as follows:
\begin{equation*}
