...
\begin{tabular}{lllccccccc} \fline
  ...
  \mr{15}{2024} & \mr{2}{Meta}  & CodeLlama-7B \citep{code-llama}         & 7B & 4,096  & \mco{2}{32}             & \mr{2}{128} & \mr{2}{16k}  & 4.3B  \\ %\cline{3-7} \cline{10-10}
         ...
         & \mr{2}{HuggingFace}  & SmolLM2-1.7B          & 1.7B  & \mr{2}{2,048} & \mr{2}{24} & \mr{2}{32} & \mr{2}{64}  &              & 0.8B  \\ \cline{9-9} %\cline{3-4} \cline{9-10}
         &                      & SmolVLM               & 2.3B  &               &            &            &             & 16k          & 1.6B  \\ \cline{2-10}
         & \mr{2}{Microsoft}    & Phi-3-mini-128k       & 3.8B  & 3,072         & \mco{2}{32}             & 96          & 128k         & 25.8B \\ %\cline{3-10}
         &                      & bitnet\_b1\_58-3B     & 3.3B  & 3,200         & 26         & 32         & 100         & 2k           & 0.3B  \\ \cline{2-10}
         & \mr{3}{Allen AI}     & OLMo-1B               & 1.3B  & 2,048         & \mco{2}{16}             & \mr{3}{128} & \mr{3}{4k}   & 0.3B  \\ %\cline{3-7} \cline{10-10}
         &                      & OLMo-2-1124-7B        & 7.3B  & 4,096         & \mco{2}{32}             &             &              & 1.1B  \\ %\cline{3-7} \cline{10-10}
         &                      & OLMo-2-1124-13B       & 13.7B & 5,120         & \mco{2}{40}             &             &              & 1.7B  \\ \cline{2-10}
         & \mr{2}{Amazon}       & Cronos-Bolt-tiny      & 9M    & 256           & \mco{2}{4}              & \mr{2}{64}  & \mr{2}{0.5k} & 1M    \\ %\cline{3-7} \cline{10-10}
         &                      & Cronos-Bolt-base      & 205M  & 768           & \mco{2}{12}             &             &              & 9.4M  \\ \cline{2-10}
         & Alibaba              & Qwen2-Audio-7B        & 8.4B  & \mr{2}{4,096} & \mco{2}{\mr{2}{32}}     & \mr{5}{128} & 8k           & 2.1B  \\ \cline{2-4} \cline{9-10}
         & \mr{2}{UW–Madison}   & llava-NeXT-video-7B   & 7.1B  &               & \mco{2}{}               &             & \mr{2}{4k}   & 1.1B  \\ \cline{1-1} \cline{5-7} %\cline{1-1} \cline{3-7} \cline{10-10}
  \mr{3}{2023} &                & llava-v1.6-vicuna-13B & 13.4B & 5,120         & \mco{2}{40}             &             &              & 1.7B  \\ \cline{2-7} \cline{9-10}
         & \mr{2}{LMSYS}        & Vicuna-7B-v1.5-16k    & ~7B   & 4,096         & \mco{2}{32}             &             & \mr{2}{16k}  & 4.3B  \\ %\cline{3-7} \cline{10-10}
         &                      & Vicuna-13B-v1.5-16k   & ~13B  & 5,120         & \mco{2}{40}             &             &              & 6.7B  \\ \hline
  \mr{5}{2022} & \mr{2}{Google} & Flan-T5-base          & 248M  & 768           & \mco{2}{12}             & \mr{6}{64}  & \mr{2}{0.5k} & 9.4M  \\ %\cline{3-7} \cline{10-10}
         ...
         &                      & Whisper-small         & 242M  & 768           & \mco{2}{12}             &             &              & 36M   \\ %\cline{3-7} \cline{10-10}
         &                      & Whisper-large-v3      & 1.5B  & 1,280         & 32         & 20         &             &              & 160M  \\ \cline{1-1} \cline{9-9} %\cline{1-1} \cline{3-7} \cline{9-10}
