...
% shortcuts
\newcommand{\mr}[2]{\multirow{#1}{*}{#2}}     % shortcut for table multirow
\newcommand{\mc}[2]{\multicolumn{#1}{c|}{#2}} % shortcut for table multicolumn
...
\begin{table}[h!] \centering \begin{tabular}{c|c|l|c|c|c|c|c|c|c}
  ...
  \mr{15}{2024} & \mr{2}{Meta}  & CodeLlama-7B          & 7B    & 4,096         & \mc{2}{32}              & \mr{2}{128} & \mr{2}{16k}  & 4.3B  \\ \cline{3-7} \cline{10-10}
         ...
         & \mr{2}{Amazon}       & Cronos-Bolt-tiny      & 9M    & 256           & \mc{2}{4}               & \mr{2}{64}  & \mr{2}{0.5k} & 1M    \\ \cline{3-7} \cline{10-10}
         &                      & Cronos-Bolt-base      & 205M  & 768           & \mc{2}{12}              &             &              & 9.4M  \\ \cline{2-10}
         & Alibaba              & Qwen2-Audio-7B        & 8.4B  & \mr{2}{4,096} & \mc{2}{\mr{2}{32}}      & \mr{5}{128} & 8k           & 2.1B  \\ \cline{2-4} \cline{9-10}
         & \mr{2}{UW–Madison}   & llava-NeXT-video-7B   & 7.1B  &               & \mc{2}{}                &             & \mr{2}{4k}   & 1.1B  \\ \cline{1-1} \cline{3-7} \cline{10-10}
  \mr{3}{2023} &                & llava-v1.6-vicuna-13B & 13.4B & 5,120         & \mc{2}{40}              &             &              & 1.7B  \\ \cline{2-7} \cline{9-10}
         & \mr{2}{LMSYS}        & Vicuna-7B-v1.5-16k    & ~7B   & 4,096         & \mc{2}{32}              &             & \mr{2}{16k}  & 4.3B  \\ \cline{3-7} \cline{10-10}
         &                      & Vicuna-13B-v1.5-16k   & ~13B  & 5,120         & \mc{2}{40}              &             &              & 6.7B  \\ \hline
  \mr{5}{2022} & \mr{2}{Google} & Flan-T5-base          & 248M  & 768           & \mc{2}{12}              & \mr{6}{64}  & \mr{2}{0.5k} & 9.4M  \\ \cline{3-7} \cline{10-10}
         &                      & Flan-T5-XXL           & 11.3B & 4,096         & 24         & 64         &             &              & 101M  \\ \cline{2-7} \cline{9-10}
         & \mr{4}{OpenAI}       & Whisper-tiny          & 38M   & 384           & 4          & 6          & & \mr{3}{\makecell{enc: 1500 \\ dec: 448}} & 6M \\ \cline{3-7} \cline{10-10}
         &                      & Whisper-small         & 242M  & 768           & \mc{2}{12}              &             &              & 36M   \\ \cline{3-7} \cline{10-10}
         &                      & Whisper-large-v3      & 1.5B  & 1,280         & 32         & 20         &             &              & 160M  \\ \cline{1-1} \cline{3-7} \cline{9-10}
  2019   &                      & GPT-2 XL              & 1.6B  & 1,600         & 48         & 25         &             & 1k           & 157M
  \end{tabular}
  \caption{Various transformers with MHA (instead of MQA or GQA) and their maximum KV-cache sizes (in number of activations) based on their respective maximum context length. $h$ is the number of attention heads, $d$ is the embedding dimension (aka hidden size), and $d_k$ is the head dimension.}
...
%\begin{align}
%  Y = \text{concat} \left( \text{head}_1, \ldots, \text{head}_h \right) W_O \\
 % \text{head}_i = \text{attention} \left( Q_i, K_i, V_i \right) = \text{softmax} \left( \frac{Q_i K_i^T}{\sqrt{d_k}} \right) V_i \label{eq2} \\
 % Q = X W_Q = \text{concat} \left( Q_1, \ldots, Q_h \right) \\
 % K = X W_K = \text{concat} \left( K_1, \ldots, K_h \right) \label{eq4} \\
 % V = X W_V = \text{concat} \left( V_1, \ldots, V_h \right) \label{eq5}
%\end{align}
