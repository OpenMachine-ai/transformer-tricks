...
The table below lists additional popular transformers with MHA, similar to Table \ref{tab1}.
%- Moonshine
%- the DNA model
%
%\begingroup \renewcommand{\arraystretch}{1.3} % increase table row height by 1.3x
...
%  2024 & Google        & CodeGemma-7B \citep{codeGemma}         & 8.5B  & 3,072         & 28         & 16         & 256  \\ \hline
%  2024 & Google        & CodeGemma-7B \citep{codeGemma}         & 8.5B  & 3,072         & 28         & 16         & 256  \\ \fline
%\end{tabular} \end{table} \endgroup
