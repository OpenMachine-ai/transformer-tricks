...
# TODO: add more LLMs
#python3 gen.py HuggingFaceTB/SmolLM-1.7B  # needs more than 8GB of DRAM
#python3 ppl.py HuggingFaceTB/SmolLM-1.7B --speedup 64
#python3 gen.py stabilityai/stablelm-2-1_6b  # uses bias! Needs more than 8GB of DRAM
#python3 gen.py microsoft/Phi-3.5-mini-instruct
...
#     8GB of DRAM is likely not an issue for running ppl.py on larger LLMs.
